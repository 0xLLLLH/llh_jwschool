...
if ($_W['ispost'] || $_W['isajax']) {
    ...
    if (!empty($_GPC['keyword'])) {
        ...
        $state_data = pdo_fetchall("SELECT * FROM " . tablename('jwschool_moments') . "WHERE id<". $last_id ." AND openid=:openid ORDER BY release_TIME DESC LIMIT 5",array(':openid'=>$_GPC['openid']));
    } else {
